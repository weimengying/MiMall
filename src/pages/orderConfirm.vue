<template>
  <div class="order-confirm">
    ...
    <div class="wrapper">
      ...
      <modal title="新增确认" :showModal="showEditModal" btnType="1" @cancel="showEditModal = false" @submit="submitAddress">
  ...
  methods: {
    ...
    getCartList() {
      this.axios.get('/carts').then((res) => {
        ...
        this.cartList = list.filter(item => item.productSelected) // 商品总金额
